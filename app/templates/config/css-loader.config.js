...
const productionLoaders = [
  ...
  { loader: 'sass-loader',
    options: {
      includePaths: [
        <% if (features.foundation) { %>path.resolve(__dirname, '../node_modules/motion-ui/src'),
        path.resolve(__dirname, '../node_modules/foundation-sites/scss'),<% } %>
        <% if (features.fontawesome) { %>path.resolve(__dirname, '../node_modules/font-awesome/scss')<% } %>
      ]
    }
  }
];
