...
<% if (features.foundation) { %>- (optional) [Foundation](http://foundation.zurb.com/) integration
<% } %><% if (features.fontawesome) { %>- (optional) [Font Awesome](http://fontawesome.io/) integration
